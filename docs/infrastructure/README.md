# Infrastructure docs (moved)

The infrastructure narrative was reorganized in v1.2. New canonical
locations:

| What you want | Where it lives now |
|---|---|
| Production deployment walk-through | [`../deployment/production.md`](../deployment/production.md) |
...
The original overlay-era infrastructure content is preserved in git
history.
